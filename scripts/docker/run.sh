...
options="-p $port:80 -v $data_path/data:/config -e PUID=0 -e PGID=0 -e DB_HOST=localhost -e DB_USER=__DB_USER__ -e DB_PASS=__DB_PWD__ -e DB_DATABASE=__DB_USER__ -e APP_URL=__URL__"
