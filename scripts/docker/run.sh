...
[ "$architecture" == "amd64" ] && image=portainer/portainer:1.23.1
[ "$architecture" == "i386" ]  && image=portainer/portainer:linux-386-1.23.1
[ "$architecture" == "armhf" ] && image=portainer/portainer:linux-arm-1.23.1
